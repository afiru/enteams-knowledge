            ...
            <div class="headerinputSearch">
                <form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
                    <div class="pore headerinputSearchLxc">
                        ...
                        <input type="image" src="<?php echo get_bloginfo('template_url'); ?>/img/btmHeaderPcGnav03.svg" alt="検索する">
                    </div>
                </form>
            </div>
        </div>
            ...
            <?php if(!empty($searchCats)): foreach($searchCats as $searchCat): ?>
                ...
                <?php if(!empty($icon)): ?>
                    <li class="liHeaderSearchCatsFx">
                        <a class="display_flex_center btmHeaderSearchCatsFx" href="<?php echo get_category_link($searchCat->cat_ID); ?>">
                            <div class="btmHeaderSearchCatsFxCnt">
