<section class="display_flex_stretch secMainSingleTitle">
    ...
    <figure class="order01 picMainSingleTitle">
        <img class="picMainSingleTitleImg" src="<?php echo $icon[0]; ?>" alt="<?php echo $nowCats[0]->cat_name; ?>アイコン画像" width="60" height="60">
    </figure>
</section>